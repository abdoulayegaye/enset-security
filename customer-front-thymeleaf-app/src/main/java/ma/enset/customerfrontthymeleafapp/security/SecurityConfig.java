package ma.enset.customerfrontthymeleafapp.security;
...
public class SecurityConfig {
    ...
    private List<SimpleGrantedAuthority> mapAuthorities(final Map<String, Object> attributes){
        ...
        Collection<String> roles = ((Collection<String>) realmAccess.getOrDefault("roles", Collections.emptyList())).stream().toList();
        return roles
                .stream()
